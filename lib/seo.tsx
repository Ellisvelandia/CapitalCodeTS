...
export const getSEOTags = ({
  ...
  return {
    ...
    title:
      title ||
      "Capital Code | Desarrollo de Software y Sitios Web Personalizados",
    // up to 160 characters (how does your app help the user?)
    description:
      description ||
      "Expertos en desarrollo de software y sitios web personalizados para empresas e individuos. Transformamos ideas en soluciones tecnológicas innovadoras.",
    ...
    applicationName: "Capital Code",
    // set a base URL prefix for other fields that require a fully qualified URL (.e.g og:image: og:image: 'https://yourdomain.com/share.png' => '/share.png')
    metadataBase: new URL(
      process.env.NODE_ENV === "development"
        ? "http://localhost:3000/"
        : `https://capital-code.vercel.app/`
    ),

    openGraph: {
      title: openGraph?.title || "Capital Code | Desarrollo de Software",
      description:
        openGraph?.description ||
        "Expertos en desarrollo de software y sitios web personalizados",
      url: openGraph?.url || `https://capital-code.vercel.app/`,
      siteName: openGraph?.title || "Capital Code",
    ...
    // twitter: {
    //   title: openGraph?.title || "Capital Code | Desarrollo de Software",
    //   description: openGraph?.description || "Expertos en desarrollo de software y sitios web personalizados",
    ...
    <script
      ...
      dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          description:
            "Expertos en desarrollo de software y sitios web personalizados para empresas e individuos. Transformamos ideas en soluciones tecnológicas innovadoras.",
          image: `https://capital-code.vercel.app/icon.png`,
          ...
          offers: [
            {
              ...
              price: "1000000000",
              priceCurrency: "USD",
              // This section is for specifying the price and currency of an offer related to the software application.
            },
          ],
        }),
      }}
